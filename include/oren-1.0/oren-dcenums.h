 ...
 * @OREN_DCLOGIN_RESULT_ERRSVRID: Invalid server ID
 * @OREN_DCLOGIN_RESULT_ERRAUTH: Authentication failed
 */
typedef enum {
    ...
    OREN_DCLOGIN_RESULT_ERRSVRID,
    OREN_DCLOGIN_RESULT_ERRAUTH
} OrenDCLoginResult;
