...
static gint   gtk_event_box_enter_notify         (GtkWidget        *widget,
                                                  GdkEventCrossing *event);
static gint   gtk_event_box_leave_notify         (GtkWidget        *widget,
                                                  GdkEventCrossing *event);
...
static gint
gtk_event_box_leave_notify (GtkWidget        *widget,
                            GdkEventCrossing *event)
{
  GtkEventBox *event_box = GTK_EVENT_BOX (widget);
  GtkEventBoxPrivate *priv = event_box->priv;
...
gtk_event_box_class_init (GtkEventBoxClass *class)
{
  ...
  widget_class->enter_notify_event = gtk_event_box_enter_notify;
  widget_class->leave_notify_event = gtk_event_box_leave_notify;
