 ...
 */
#ifndef __OREN_DC_TYPES_H__
#define __OREN_DC_TYPES_H__
...
typedef struct _OrenDCChannel OrenDCChannel;
typedef struct _OrenDCUser OrenDCUser;

G_END_DECLS

#endif /* __OREN_DC_TYPES_H__ */
